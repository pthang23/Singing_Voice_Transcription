...
from feature.wrapper_func import extract_cfp_feature
from utils import write_yaml, write_agg_f0_results, get_logger, ensure_path_exists, parallel_generator, resolve_dataset_type, aggregate_f0_info
from train import train_epochs, get_train_val_feat_file_list
from vocal_contour.callbacks import EarlyStopping, ModelCheckpoint
from vocal_contour.inference import inference
from vocal_contour import labels as lextor
from constants import datasets as d_struct
from models.u_net import semantic_segmentation
...
class VocalContourTranscription(BaseTranscription):
    ...
    def generate_feature(self, dataset_path, vocalcontour_settings=None, num_threads=4):
        ...
        struct = d_struct.VocalContourStructure
        label_extractor = lextor.VocalContourlabelExtraction
    ...
    def train(self, feature_folder, model_name=None, input_model_path=None, vocalcontour_settings=None):
        ...
        if input_model_path is None:
            ...
            # Note: The default value of dropout rate for ConvBlock is different in VocalSeg which is 0.2.
