...
ap.add_argument('-fs', '--feature_semi', required=False, help='Path to the folder of extracted semi feature')
...
feature_semi = args.feature_semi if args.feature_semi is not None else None
...
va_transcription.train(feature_folder=args.feature, semi_feature_folder=feature_semi, model_name=output_model, input_model_path=input_model, vocal_settings=config)